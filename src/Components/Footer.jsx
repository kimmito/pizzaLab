            ...
            <div className="footer__container">
                <div className="footer__nav">
                    ...
                    <ul className="footer__nav__list">
                        ...
                        <li className="footer__nav__item" onClick={() => props.handleCategoryChange(null)}><a href="#menu" className="footer__nav__link">Показать все</a></li>
                        <li className="footer__nav__item" onClick={() => props.handleCategoryChange("мясная")}><a href="#menu" className="footer__nav__link">Мясные</a></li>
                        <li className="footer__nav__item" onClick={() => props.handleCategoryChange("вегатерианская")}><a href="#menu" className="footer__nav__link">Вегатерианские</a></li>
